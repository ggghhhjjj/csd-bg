...
const BG = {
  ...
  'header.home': 'Начало',
  'header.refreshData': 'Опресни данните',
  'header.upgradeApp': 'Обнови приложението',
  'header.help': 'Помощ',
  'header.locale': 'EN',
  ...
  'chart.export': 'Експорт на данни',
  'chart.exportCsv': 'CSV',
  'chart.exportMarkdown': 'Markdown таблица',
  'chart.exportCopied': 'Копирано',
  'table.date': 'Дата',
  ...
  'error.appConfigMissing': 'Липсва конфигурация за версия на приложението.',
  'error.appConfigInvalid': 'Невалидна конфигурация за версия на приложението.',
...
export const TRANSLATIONS: Record<AppLocale, Record<TranslationKey, string>> = {
  ...
  en: {
    ...
    'header.upgradeApp': 'Upgrade application',
    'header.help': 'Help',
    'header.locale': 'BG',
    'header.share': 'Share',
    ...
    'compare.close': 'Close',
    'chart.export': 'Export data',
    'chart.exportCsv': 'CSV',
    'chart.exportMarkdown': 'Markdown table',
    'chart.exportCopied': 'Copied',
    'table.date': 'Date',
    ...
    'error.appConfigMissing': 'Application version configuration is missing.',
    'error.appConfigInvalid': 'Invalid application version configuration.',
